...
namespace CodeDocs
{
    ...
    /// <summary>Reinventing the wheel instead of using built-in or pre-built code (.net, nuget, etc)</summary>
    public sealed class ReinventingAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// Reinventing the wheel instead of using built-in or pre-built code (.net, nuget, etc)
        /// </summary>
