...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class TodoDefinition : IDefinition, IFunctionalTag, IWorkTag, IDegredationTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Functional, Tag.Work, Tag.Degredation }; } }
