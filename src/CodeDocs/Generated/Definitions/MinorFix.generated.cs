...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class MinorFixDefinition : IDefinition, IFunctionalTag, IChangeTag, IMinorTag, IFixTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Functional, Tag.Change, Tag.Minor, Tag.Fix }; } }
