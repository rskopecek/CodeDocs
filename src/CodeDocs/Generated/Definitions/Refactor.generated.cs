...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class RefactorDefinition : IDefinition, IConfidenceTag, IDegredationTag, IOnePerContextTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Confidence, Tag.Degredation }; } }
