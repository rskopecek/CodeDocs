...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class PurposeDefinition : IDefinition, IConfidenceTag, IMeaningTag, ISRPTag, IOnePerContextTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Confidence, Tag.Meaning, Tag.SRP }; } }
