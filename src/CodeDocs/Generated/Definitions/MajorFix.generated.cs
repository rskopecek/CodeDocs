...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class MajorFixDefinition : IDefinition, IFunctionalTag, IChangeTag, IMajorTag, IFixTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Functional, Tag.Change, Tag.Major, Tag.Fix }; } }
