...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class ToxicDefinition : IDefinition, ISafetyTag, IToxicTag, IDegredationTag, IOnePerContextTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Safety, Tag.Toxic, Tag.Degredation }; } }
