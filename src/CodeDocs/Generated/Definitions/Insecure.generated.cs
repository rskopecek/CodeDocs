...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class InsecureDefinition : IDefinition, ISafetyTag, ISecurityTag, IInSecureTag, IDegredationTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Safety, Tag.Security, Tag.InSecure, Tag.Degredation }; } }
