...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class CiteDefinition : IDefinition, IBelongingTag, IMeaningTag
	{
		...
		/// </summary>
		public string Description { get { return "Used to identify external resources (like StackOverflow, blogs, etc) that would add value to the context this attribute is applied to."; } }
