...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class DeadCodeDefinition : IDefinition, ISafetyTag, IDeadCodeTag, IConsequenceTag, IOnePerContextTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Safety, Tag.DeadCode, Tag.Consequence }; } }
