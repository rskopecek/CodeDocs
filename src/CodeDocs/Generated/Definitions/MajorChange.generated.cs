...
namespace CodeDocs.Definitions
{
	...
	/// </summary>
	public sealed class MajorChangeDefinition : IDefinition, IBelongingTag, IChangeTag, IMajorTag
	{
		...
		/// </summary>
		public Tag[] Tags { get { return new[]{ Tag.Belonging, Tag.Change, Tag.Major }; } }
