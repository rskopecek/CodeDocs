...
namespace CodeDocs
{
    ...
    /// <summary>The general design of the item needs to be reconsidered</summary>
    public sealed class DesignAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The general design of the item needs to be reconsidered
        /// </summary>
