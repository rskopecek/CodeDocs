...
namespace CodeDocs
{
    ...
    /// <summary>The name of this item should be reconsidered</summary>
    public sealed class NamingAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The name of this item should be reconsidered
        /// </summary>
