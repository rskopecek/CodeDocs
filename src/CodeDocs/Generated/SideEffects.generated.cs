...
namespace CodeDocs
{
    ...
    /// <summary>The code has side effects which is either not clear or shouldn't occur</summary>
    public sealed class SideEffectsAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The code has side effects which is either not clear or shouldn't occur
        /// </summary>
