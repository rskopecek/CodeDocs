...
namespace CodeDocs
{
    ...
    /// <summary>The code has or will have an availability issue that will need to be reconsidered</summary>
    public sealed class AvailabilityAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The code has or will have an availability issue that will need to be reconsidered
        /// </summary>
