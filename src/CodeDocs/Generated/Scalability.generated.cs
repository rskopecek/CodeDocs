...
namespace CodeDocs
{
    ...
    /// <summary>The code has or will have a scalability issue that will need to be reconsidered</summary>
    public sealed class ScalabilityAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The code has or will have a scalability issue that will need to be reconsidered
        /// </summary>
