...
namespace CodeDocs
{
    ...
    /// <summary>From all appearances the code can be removed, but need a formal review</summary>
    public sealed class DeadCodeAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// From all appearances the code can be removed, but need a formal review
        /// </summary>
