...
namespace CodeDocs
{
    ...
    /// <summary>The code has or will have an integrity issue that will need to be reconsidered</summary>
    public sealed class IntegrityAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The code has or will have an integrity issue that will need to be reconsidered
        /// </summary>
