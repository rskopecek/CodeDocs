...
namespace CodeDocs
{
    ...
    /// <summary>The code is known to be or potentially less than reasonably performant</summary>
    public sealed class SlowAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// The code is known to be or potentially less than reasonably performant
        /// </summary>
