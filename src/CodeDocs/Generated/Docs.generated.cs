...
namespace CodeDocs
{
    ...
    /// <summary>Code is here, but some kind of documentation needs updated to reflect (ex. visio)</summary>
    public sealed class DocsAttribute : CodeDocsAttribute
    {
        /// <summary>
        /// Code is here, but some kind of documentation needs updated to reflect (ex. visio)
        /// </summary>
