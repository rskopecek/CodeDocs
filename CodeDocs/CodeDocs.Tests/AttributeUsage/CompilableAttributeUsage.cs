...
namespace CodeDocs.Tests.AttributeUsage
{
	...
	[MinorChange("")] internal interface IMinorChangeExample{}
	[MinorChange("")] internal struct MinorChangeStructExample{}
	[MinorChange("")] internal class MinorChangeExample : IMinorChangeExample
	{
		[MinorChange("")] internal MinorChangeExample() { Variable1 = "1"; Property1 = "1"; }
		[MinorChange("")] private enum Enum1 {B};
		[MinorChange("")] private readonly string Variable1;
		[MinorChange("")] private string Property1 { get; set; }
		[MinorChange("")] private Enum1 MethodParam1(Enum1 abc){return abc;}
		[MinorChange("")] delegate bool Delegate1();
		[MinorChange("")]event Delegate1 Event1;
	}
